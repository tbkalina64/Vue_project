<template>
  <main class="terms">
    ...
    <p>
      Welcome to vtinbox.com! These terms and conditions outline the rules and
      regulations for the use of Vermont Innovation Box 's Website, located at
      <a class="terms__link" href="https://vtinbox.com">https://vtinbox.com/</a
      >. By accessing this website we assume you accept these terms and
      conditions. Do not continue to use vtinbox.com if you do not agree to take
      ...
      in accordance with and subject to, prevailing law of Vermont, United
      States . Any use of the above terminology or other words in the singular,
      plural, capitalization and/or he/she or they, are taken as interchangeable
      and therefore as referring to same.
    </p>
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By accessing vtinbox.com, you agreed to use
      cookies in agreement with the Vermont Innovation Box 's Privacy Policy.
    ...
    <h2>License</h2>
    <p>
      Unless otherwise stated, Vermont Innovation Box and/or its licensors own
      the intellectual property rights for all material on vtinbox.com. All
      intellectual property rights are reserved. You may access this from
      vtinbox.com for your own personal use subjected to restrictions set in
      these terms and conditions. You must not:
    </p>
    <ul class="terms__list">
      <li>Republish material from vtinbox.com</li>
      <li>Sell, rent or sub-license material from vtinbox.com</li>
      <li>Reproduce, duplicate or copy material from vtinbox.com</li>
      <li>Redistribute content from vtinbox.com</li>
    </ul>
    <p>
      This Agreement shall begin on the date hereof. Parts of this website offer
      an opportunity for users to post and exchange opinions and information in
      certain areas of the website. Vermont Innovation Box does not filter,
      edit, publish or review Comments prior to their presence on the website.
      Comments do not reflect the views and opinions of Vermont Innovation Box
      ...
      applicable laws, Vermont Innovation Box shall not be liable for the
      ...
      Comments on this website. Vermont Innovation Box reserves the right to
    ...
    <p>
      You hereby grant Vermont Innovation Box a non-exclusive license to use,
    ...
    <p>
      ...
      hyperlink compensates the absence of Vermont Innovation Box ; and (d) the
      ...
      our website, you must inform us by sending an e-mail to Vermont Innovation
      Box . Please include your name, your organization name, contact
      ...
      which you would like to link. Wait 2-3 weeks for a response. Approved
    ...
    <p>
      No use of Vermont Innovation Box 's logo or other artwork will be allowed
...
export default {
  ...
  mounted() {
    window.scroll(0, 0);
    this.$nuxt.$emit("title", "Terms of use");
  },
};
</script>
